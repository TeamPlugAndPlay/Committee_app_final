...
//class credit http://www.appliedcodelog.com/2016/06/expandablelistview-in-xamarin-android.html
namespace Committee_app_final
{
    public class ExpandableListAdapter : BaseExpandableListAdapter
    {
        ...
        public override View GetChildView(int groupPosition, int childPosition, bool isLastChild, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null)
            {
                convertView = _context.LayoutInflater.Inflate(Resource.Layout.ItemListLayout, null);
            }
        ...
        public override View GetGroupView(int groupPosition, bool isExpanded, View convertView, ViewGroup parent)
        {
            ...
            convertView = convertView ?? _context.LayoutInflater.Inflate(Resource.Layout.HeaderLayout, null);
